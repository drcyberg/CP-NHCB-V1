...
The communication **Network Helper Communication Board** is designed to allow direct connection to the Raspberry Pi using a miniUSB cable without opening the case.
